...
/**
 * Dialog do dodawania nowego przypomnienia.
 */
class AddReminderDialog(
    private val onSave: (title: String, message: String, intervalMinutes: Int, categoryIcon: String?) -> Unit
) : DialogFragment() {

    private var _binding: DialogAddReminderBinding? = null
    private val binding get() = _binding!!

    private var currentIntervalMinutes = 120 // Domyślnie 2 godziny
    ...
    /**
     * Waliduje i zapisuje przypomnienie.
     */
    private fun saveReminder() {
        ...
        // Zapisz
        onSave(title, message, currentIntervalMinutes, null)
        dismiss()
    }
